...
year = '2017'
split = 'train'
vg_object_data = pkl.load(open(preprocessed_dir+'/'+year+'/'+split+'/mrcnn_output_vg_objects.pkl', 'rb'), encoding='latin1')
...
pkl.dump(rel_data, open(preprocessed_dir+'/'+year+'/'+split+'/mrcnn_output_vg_relationships.pkl','wb'))            
